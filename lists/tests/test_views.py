...
class NewListTest(TestCase):
    ...
    def test_for_invalid_input_renders_hme_template(self):
...
class ListViewTest(TestCase):
    ...
    def test_for_invalid_input_shows_error_on_page(self):
        response = self.post_invalid_input()
        self.assertIn(escape(EMPTY_ITEM_ERR), response.content.decode())
        self.assertContains(response.content.decode(), escape(EMPTY_ITEM_ERR))
